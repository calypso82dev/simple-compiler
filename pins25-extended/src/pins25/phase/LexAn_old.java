 ...
 */
public class LexAn_old implements AutoCloseable {
	 ...
	 */
	public LexAn_old(final String srcFileName) {
		try {
	...
	public static void main(final String[] cmdLineArgs) {
		...
		try {
			...
			try (LexAn_old lexAn = new LexAn_old(cmdLineArgs[0])) {
