...
public class AST {
	...
	public static class ForStmt extends Stmt {
		...
		/** Start expression */
		public final Expr startExpr;
		
		/** End expression */
		public final Expr endExpr;
		
		/** Statements in loop body */
		public final Nodes<Stmt> stmts;

		/**
		 * Create new for loop statement
		 * 
		 * @param varName   Loop variable name
		 * @param startExpr Start expression  
		 * @param endExpr   End expression
		 * @param stmts     Loop body statements
		 */
		public ForStmt(final String varName, final Expr startExpr, final Expr endExpr, final List<Stmt> stmts) {
			super();
	...
	public static interface Visitor<Result, Argument> {
		@SuppressWarnings({ "doclint:missing" })
		public default Result visit(final ForStmt forStmt, final Argument arg) {
			throw new Report.InternalError();
		}
		@SuppressWarnings({ "doclint:missing" })
	...
	public static interface FullVisitor<Result, Argument> extends Visitor<Result, Argument> {
		@Override
		public default Result visit(final ForStmt forStmt, final Argument arg) {
			forStmt.startExpr.accept(this, arg);
			forStmt.endExpr.accept(this, arg);
			forStmt.stmts.accept(this, arg);
			return null;
		}
	...
	public static class Logger {
		...
		private class LoggerVisitor implements AST.FullVisitor<Object, LoggerVisitor.Log> {
			...
			@Override
			public Object visit(final AST.ForStmt forStmt, final Log log) {
				print(log.indent, forStmt, "\033[1m" + "ForStmt " + forStmt.varName + "\033[0m");
				{
					forStmt.startExpr.accept(this, log.advance("StartExpr:"));
					forStmt.endExpr.accept(this, log.advance("EndExpr:"));
					forStmt.stmts.accept(this, log.advance("ForStmts:"));
				}
				return null;
			}
