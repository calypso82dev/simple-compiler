...
public class AST {
    ...
    public static class UntilStmt extends Stmt {
         ...
         * @param stmts Stavki telesa zanke.
         */
        public UntilStmt(final Expr cond, final List<Stmt> stmts) {
            super();
            this.cond = cond;
            this.stmts = new Nodes<Stmt>(stmts);
        }
	...
	public static interface Visitor<Result, Argument> {
        ...
        @SuppressWarnings({ "doclint:missing" })
        public default Result visit(final UntilStmt untilStmt, final Argument arg) {
            throw new Report.InternalError();
        }
	...
	public static interface FullVisitor<Result, Argument> extends Visitor<Result, Argument> {
        ...
        @Override
        public default Result visit(final UntilStmt untilStmt, final Argument arg) {
            untilStmt.cond.accept(this, arg);
            untilStmt.stmts.accept(this, arg);
            return null;
        }
	...
	public static class Logger {
		...
		private class LoggerVisitor implements AST.FullVisitor<Object, LoggerVisitor.Log> {
            ...
            @Override
            public Object visit(final AST.UntilStmt untilStmt, final Log log) {
                print(log.indent, untilStmt, "\033[1m" + "UntilStmt" + "\033[0m");
                {
                    untilStmt.cond.accept(this, log.advance());
                    untilStmt.stmts.accept(this, log.advance("UntilStmts:"));
                }
                return null;
            }
