...
public class AST {
	 ...
	 * Do-until zanka.
	 */
	public static class DoUntilStmt extends Stmt {
		...
		/**
		 * Ustvari novo do-until zanko.
		 * 
		 * @param stmts Stavki telesa zanke.
		 * @param cond  Pogoj.
		 */
		public DoUntilStmt(final List<Stmt> stmts, final Expr cond) {
			super();
			this.stmts = new Nodes<Stmt>(stmts);
			this.cond = cond;
		}
	...
	public static interface Visitor<Result, Argument> {
		...
		@SuppressWarnings({ "doclint:missing" })
		public default Result visit(final DoUntilStmt doUntilStmt, final Argument arg) {
			throw new Report.InternalError();
		}

		@SuppressWarnings({ "doclint:missing" })
		public default Result visit(final BreakStmt breakStmt, final Argument arg) {
			throw new Report.InternalError();
		}
	...
	public static interface FullVisitor<Result, Argument> extends Visitor<Result, Argument> {
		...
		@Override
		public default Result visit(final DoUntilStmt doUntilStmt, final Argument arg) {
			doUntilStmt.stmts.accept(this, arg);
			doUntilStmt.cond.accept(this, arg);
			return null;
		}
	...
	public static class Logger {
		...
		private class LoggerVisitor implements AST.FullVisitor<Object, LoggerVisitor.Log> {
			...
			// NEW
			@Override
			public Object visit(final AST.DoUntilStmt doUntilStmt, final Log log) {
				print(log.indent, doUntilStmt, "\033[1m" + "DoUntilStmt" + "\033[0m");
				{
					doUntilStmt.stmts.accept(this, log.advance("DoUntilStmts:"));
					doUntilStmt.cond.accept(this, log.advance());
				}
				return null;
			}

			@Override
			public Object visit(final AST.BreakStmt breakStmt, final Log log) {
				print(log.indent, breakStmt, "\033[1m" + "BreakStmt" + "\033[0m");
				{
				}
				return null;
			}
